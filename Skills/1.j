scope KageBunshin initializer Init
    ...
    private function AtkedCond takes nothing returns boolean
        ...
        if (GetUnitTypeId(atker) == cloneType) and (GetOwningPlayer(atker) == Naruto_Player) and (GetRandomInt(0, 99) < skChance) then
            ...
            call SetUnitAnimation(atker, "Spell Four")
            set countdown = 30
    ...
    private function ActEnd takes nothing returns nothing
        ...
        call UnitApplyTimedLife(CreateUnit(Naruto_Player, 'h01K', GetUnitX(caster), GetUnitY(caster), GetUnitFacing(caster)), 1112820806, 1.00)
    ...
    private function ClearOldShadowClone takes nothing returns nothing
        ...
        loop
            ...
            if (GetUnitAbilityLevel(picked, illusionBuff) > 0) then
    ...
    private function Act takes nothing returns nothing
        ...
        call UnitApplyTimedLife(CreateUnit(Naruto_Player, 'h013', GetUnitX(caster), GetUnitY(caster), GetUnitFacing(caster)), 1112820806, 1.00)
